...
function Footer() {
  return (
    <div
      ...
      data-scroll-section
      data-scroll-speed="-.3"
      className=" flex w-full h-screen p-20 "
    >
      <div className='w-1/2 h-full flex flex-col justify-between font-["Neue_Montreal"]'>
        <div className="heading">
          <h1 className="uppercase text-[7vw] leading-none -mb-2 font-extrabold">
            EYE-
          </h1>
          <h1 className="uppercase text-[7vw] leading-none tracking-tighter font-extrabold">
            Opening
          </h1>
        </div>
        <svg
      ...
      <div className="w-1/2 flex flex-col">
        <h1 className="uppercase tracking-tighter text-[6.6vw] leading-none -mb-5 font-bold">
          Presentations
        </h1>
        <div className="dets relative  flex flex-col gap-8 mt-10">
          <h2 className=' font-["Neue_Montreal"] font-extrabold'>S:</h2>
        ...
        <div className="dets relative  flex flex-col gap-8 mt-10">
          <h2 className=' font-["Neue_Montreal"] font-extrabold'>L:</h2>
          <a href="#" className="hover-link">
            Vancouver, Canada
          </a>
          <a href="#" className="hover-link">
